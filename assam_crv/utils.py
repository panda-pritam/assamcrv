...
PRA_MAIN_MAPPING = {
    ...
    'Access to market for output produce': 'access_to_market_output_produce',
    'Access to market for input produce': 'access_to_market_input_produce',
    'Access to high quality seeds': 'access_to_high_quality_seeds',
    ...
    'Access to technology': 'access_to_technology',
    'More than one crop a year': 'more_than_one_crop_a_year',
    'Diversity of crops': 'diversity_of_crops',
      'Access to knowledge (KVK), on farming': 'access_to_knowledge_kvk_on_farming',
      'Access to health service including vaccination': 'access_to_health_service_including_vaccination',
}
