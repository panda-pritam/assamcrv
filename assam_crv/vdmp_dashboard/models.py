...
class HouseholdSurvey(models.Model):
    ...
    loss_AgriLivli=models.CharField(max_length=255, null=True, blank=True)
    ...
    building_length_feet=models.CharField(max_length=255, null=True, blank=True)   
    building_width_feet=models.CharField(max_length=255, null=True, blank=True)    
    building_length_meter=models.CharField(max_length=255, null=True, blank=True)   
    building_width_meter=models.CharField(max_length=255, null=True, blank=True)    
    build_area_meter=models.CharField(max_length=255, null=True, blank=True)
    maximum_flood_height_meter=models.CharField(max_length=255, null=True, blank=True)
    plinth_or_stilt_height_meter=models.CharField(max_length=255, null=True, blank=True)
    flood_depth_from_survey_meter=models.CharField(max_length=255, null=True, blank=True)
...
class Commercial(models.Model):
    ...
    plinth_or_srilt_height_meter=models.CharField(max_length=255, null=True, blank=True)
...
class VdmpVillageMapData(models.Model):
    ...
    class Meta:
        db_table = "vdmp_village_map_Data"

    def __str__(self):
        return f"{self.village.name} Maps Data"


class VdmDistrictMapData(models.Model):
    ...
    def __str__(self):
        return f"{self.district.name} Maps Data"
...
class Upload_data_vdmp(models.Model):
    ...
    selection_level = models.CharField(max_length=50,blank=True,null=True)
...
class OtherData(models.Model):
    ...
    assets_type = models.CharField(max_length=255, null=True, blank=True)
    ...
    water_tank_structure_type = models.CharField(max_length=255, null=True, blank=True)
    observation = models.TextField(null=True, blank=True)

    status_working = models.CharField(max_length=255, null=True, blank=True)
    asset_name = models.CharField(max_length=255, null=True, blank=True)

    created_at = models.DateTimeField(auto_now_add=True)

    def __str__(self):
        return f"{self.village_name} - {self.asset_name}"
