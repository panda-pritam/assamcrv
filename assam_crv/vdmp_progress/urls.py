...
from .views import ( get_vdmp_activity_status, admin_get_vdmp_activity_status, create_vdmp_activity, 
                    ...
                    vdmp_progress_page, dropdown_vdmp_activity, delete_and_rerun_pipeline)
...
urlpatterns = [
    ...
    path('api/delete_and_rerun_pipeline/<int:status_id>/', delete_and_rerun_pipeline, name='delete_and_rerun_pipeline'),
