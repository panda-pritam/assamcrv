...
from .views import ( get_districts, get_circles, get_gram_panchayats, get_villages, villages_by_district, 
                    ...
                    create_circle, create_district, create_gram_panchayat, create_village, update_circle, update_district
                     ,update_gram_panchayat, update_village, delete_circle, delete_district, delete_gram_panchayat, delete_village,update_locations, get_village_count, get_location_counts, sync_mobile_db_villages, get_village_by_id, get_all_villages_public )
...
urlpatterns = [
    ...
    path('api/get_all_villages_public', get_all_villages_public, name='get_all_villages_public'),
